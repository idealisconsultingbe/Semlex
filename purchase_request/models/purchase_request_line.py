...
class PurchaseRequestLine(models.Model):
    ...
    def _date_expected_to_string(self):
        for line in self:
            line.date_expected_str = line.date_expected.strftime("%m/%d/%Y")

    @api.depends('product_qty', 'product_id', 'price_unit')
    ...
    def _onchange_product_id(self):
        """ Recompute request line and request total"""
        self.purchase_request_id.amount_total._amount_all()
